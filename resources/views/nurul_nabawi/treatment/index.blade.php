            ...
            <div class="col-xs-12">
                <div class="box" style="padding: 0 30px">
                  <div class="box-header">
                    <div class="box-header">
                      <h5 class="box-title">Tambah data tindakan klinik Nurul Nabawi Al-Kautsar</h5>
                    </div>
                    <div class="box-body">
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box" style="padding: 0 30px">
            <div class="box-header">
              <div class="box-header">
                <h5 class="box-title">Data tindakan klinik Nurul Nabawi Al-Kautsar</h5>
              </div>
              <!-- /.box-header -->
              <div class="box-body">
